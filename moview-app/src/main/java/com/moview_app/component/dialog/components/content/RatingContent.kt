package com.moview_app.component.dialog.components.content
...
import com.moview_app.ui.util.getAnnotatedText
    ...
    Column(
        ...
        Text(
            ...
            style = MaterialTheme.typography.labelLarge.copy(
                color = MaterialTheme.movieColorSchemes.secondary
            ),
...
fun ColumnScope.StarRatingBar(score: Float) {
    Card(
        ...
        Box(
            ...
            val starBackgroundColor = MaterialTheme.movieColorSchemes.primaryContainer.copy(
                alpha = 0.2f
            ).toArgb()
            val ratingBackgroundColor = MaterialTheme.movieColorSchemes.primaryContainer.copy(
                alpha = 0.05f
            ).toArgb()
